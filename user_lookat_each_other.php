...
<div id="total">
    ...
    <div id="middle">
        ...
        #Search:
            ...
            mysqli_stmt_bind_param($stmt_search,"isii",$id,$search,$num_news_per_page,$num_page_bypass);
        ...
        <table border="1" width="100%">
            <caption>
                <form>
                    Search <input type="search" name="search" value="<?php echo $search1 ?>">
                </form>
            </caption>
            <tr>
                <th>Title</th>
        ...
        <?php for ($page=1; $page <= $num_page; $page++) { ?>
                <a href="?ID=<?php echo $id ?> &page=<?php echo $page ?> &search=<?php echo $search1 ?>">
                    <?php echo $page ?>
                </a>
        <?php } ?>
